...
class RegistrationView(View):
    ...
    def post(self, request):
        ...
        # messages.success(request, "Success A")
        # messages.error(request, "Error A")
        # messages.info(request, "Info A")
        # messages.warning(request, "Warning A")
        context ={
        ...
        if not User.objects.filter(username=username).exists():
            ...
            if not User.objects.filter(email=email).exists():
                ...
                email_body='Hi' + user.username + 'Verify your account\n' + activate_url
                email = EmailMessage(
                    email_subject,
                    email_body,
                    'riynjeck@gmail.com',
...
class RequestPasswordResetEmail(View):
    ...
    def post(self, request):
        ...
        if not validate_email(email):
            messages.error(request,"Please validate email")
            return render(request,'authentication/reset-password.html')
